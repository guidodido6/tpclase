...
// Importación de la interfaz marcadores desde la ruta especificada
import { marcadores } from 'src/app/models/marcadores';

@Component({
  selector: 'app-indumentaria', // Define el selector del componente
  templateUrl: './indumentaria.component.html', // Ruta al archivo de plantilla HTML del componente
  styleUrls: ['./indumentaria.component.css'] // Ruta al archivo de estilos CSS del componente
})
export class IndumentariaComponent {
  // Propiedad pública de tipo array que contendrá información de marcadores
